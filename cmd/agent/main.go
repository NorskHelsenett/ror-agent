...
import (
	...
	"github.com/NorskHelsenett/ror-agent/cmd/agent/controllers"
	"github.com/NorskHelsenett/ror-agent/cmd/agent/httpserver"
	"github.com/NorskHelsenett/ror-agent/cmd/agent/scheduler"
