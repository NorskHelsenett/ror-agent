...
require (
	github.com/NorskHelsenett/ror v1.19.0
	github.com/NorskHelsenett/ror-agent/common v1.0.10
...
require (
	...
	github.com/dotse/go-health v1.0.3 // indirect
	...
	github.com/vitistack/common v0.8.67 // indirect
